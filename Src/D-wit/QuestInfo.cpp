...
{
    {
        ...
        npc.strContents1 =
            ...
            "2022년 7월???\n"
            "뭐야? 내 5개월 어디 갔어?\n"
            "수료하고 휴학하는 동안 좀 쉬려고 했는데...\n"
            "왜 갑자기 여름이냐고!!!!!!!!\n"
            "(잔디 앱에 알림이 뜬다.)\n"
            "공통교육 공지사항? 이게 왜 나한테 와?\n"
            "엥? 교육생 명단에 내가 있잖아??\n"
            "설마...\n"
            "1년 더 해야 하는 거야??????\n"
            "아니야... 아닐 거야...\n"
            "그래! 꿈이겠지! 때려보자 (찰싹)\n"
            "아프네... 큰일이네...\n"
            "일단 BoB 센터 앞이니까 들어가서 확인해보지 뭐.\n"
            ;

        npc.strContents2 = 
            "포렌식트랙... 오랜만이네.\n"
            "작년 트랙별교육은 빡셌는데... 올해는 괜찮겠...지?\n"
        ...
        npc.strContents4 = 
            ...
            "BoB 하는 7개월 동안 진짜 별의별 일들 다 겪게 될거야.\n"
            "특히 올해도 비대면으로 하면 몸 진짜 많이 망가질 거고.\n"
            "나처럼 고생 안 하게 운동 꾸준히 하고, 자세 틈틈이 고쳐 앉고,\n"
            "또 뭐 있더라... 아무튼 잘 해낼 수 있을 거라 믿는다!\n"
            ;
...
void CQuestInfo::QueryQuest(std::vector<ST_QUEST_DATA>& vecQuest)
{
    ...
    //D-wit
    {
        ...
        stQuest.vecMessages.push_back("'C'라고 생겼던 것 같은디... 암튼지간에 그 택배 박스 내 거 맞는지 좀 확인혀줘봐아.");
    ...
    //D-wit
    {
        ...
        stQuest.vecMessages.push_back("아, 그리구 실지로는 이 정도로 사투리 안햐. NPC 말고 캐릭터였으면은 거진 서울말만 쓸겨.");

...
void CQuestInfo::QueryQuest(std::vector<ST_QUEST_DATA>& vecQuest)
{
    // 최한수 id: 158
    {
        ...
        stQuest.ClearCondition = ST_FILTER(158, 0x0002);
    ...
    // 최한수
    {
        ...
        stQuest.ClearCondition = ST_FILTER(158, 0x0004);
        vecQuest.push_back(stQuest);
    }
    ...
    // 수면안대 id: 282
    {
        ST_QUEST_DATA stQuest;
        stQuest.nNpcId = 282;
        stQuest.StartCondition = ST_FILTER(158, 0x0003, 0x0004);
        ...
        stQuest.ClearCondition = ST_FILTER(158, 0x0005);
        vecQuest.push_back(stQuest);
    }
    ...
    // 최한수
    {
        ST_QUEST_DATA stQuest;
        stQuest.nNpcId = 158;
        stQuest.StartCondition = ST_FILTER(158, 0x0004, 0x0005);
